...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var e, t = _gsScope.document, p = t.defaultView ? t.defaultView.getComputedStyle : function () {
    ...
    w = function (e) {
      for (
        var t = -1 !== (window ? window.location.href : "").indexOf(String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107)) // greensock
          && -1 !== e.indexOf(String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116)), // localhost
          r = [
            S,
